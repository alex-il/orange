 ...
 */  
  def main(args: Array[String]): Unit = {
  	val ifaDto = loadIFAdminDTO("d:\\2\\update.param")
    testCreateCWPs(ifaDto)
//    createCWPs
  }
  
  
  def testCreateCWPs(dto:IFAdminDTOJ): Unit = {
    println("Working .....................")
    val startTime = System.currentTimeMillis()
    val srcUrl = "https://"+dto.ssgHost+":"+dto.ssgPort+"/wsman"
    println("Url:_" +srcUrl)
